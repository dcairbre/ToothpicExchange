...
namespace OpenDentalCloud {
	...
	public static class Sftp {
		...
		private static SftpClient Init(string host,string user,string pass) {
			return new SftpClient(new ConnectionInfo(host,user,new AuthenticationMethod[] { new PasswordAuthenticationMethod(user,pass) }));
		}

		public class Upload : TaskStateUpload {
			private SftpClient _client;

			public Upload(string host,string user,string pass) {
		...
		public class Download : TaskStateDownload {
			...
			public Download(string host,string user,string pass) {
				_client=Init(host,user,pass);
			}
	...
	public static class SftpExtension {
		...
		static public void CreateDirectoriesIfNeeded(this SftpClient client,string path) {
			bool hadToConnect=client.ConnectIfNeeded();
		...
		static public bool ConnectIfNeeded(this SftpClient client) {
		...
		static public void DisconnectIfNeeded(this SftpClient client,bool hadToConnect) {
