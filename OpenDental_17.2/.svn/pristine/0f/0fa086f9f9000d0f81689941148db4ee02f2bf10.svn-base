...
///<summary></summary>
    ...
    "t\'s edit form.";
		...
		private void butDelete_Click(object sender,EventArgs e) {
			...
			if(Claims.IsReferralAttached(RefCur.ReferralNum)) {
				MsgBox.Show(this,"Cannot delete Referral because it is attached to claims");
				return;
			}
			if(Procedures.IsReferralAttached(RefCur.ReferralNum)) {
				MsgBox.Show(this,"Cannot delete Referral because it is attached to procedures");
				return;
			}
