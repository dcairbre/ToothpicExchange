...
namespace OpenDentBusiness{
	...
	public class Providers {
		...
		///<summary></summary>
		public static string GetAbbr(long provNum,List<Provider> listProvs=null) {
			//No need to check RemotingRole; no call to db.
			if(listProvs==null) {
	  ...
	  ///<summary>Used in the HouseCalls bridge</summary>
		...
		public static List<Provider> GetProvsByFLName(string lName,string fName) {
			...
			return ProviderC.GetListLong().FindAll(x => x.LName.ToLower()==lName.ToLower() && x.FName.ToLower()==fName.ToLower());
		}
