...
namespace OpenDental{
	...
	public class FormAudit : ODForm {
		...
		private void InitializeComponent()
		{
			...
			// textRows
			// 
			this.textRows.Location = new System.Drawing.Point(750, 26);
			...
			this.textRows.TabIndex = 226;
			// 
			// label6
			// 
			this.label6.Location = new System.Drawing.Point(747, 7);
			...
			this.butPrint.Location = new System.Drawing.Point(834, 27);
			...
			this.butCurrent.Location = new System.Drawing.Point(512, 24);
			...
			this.butAll.Location = new System.Drawing.Point(655, 24);
			...
			this.butFind.Location = new System.Drawing.Point(584, 24);
			...
			// textPatient
			// 
			this.textPatient.Location = new System.Drawing.Point(512, 4);
			...
			this.comboUser.Size = new System.Drawing.Size(183, 21);
			...
			// label4
			// 
			this.label4.Location = new System.Drawing.Point(446, 8);
			...
			this.comboPermission.Size = new System.Drawing.Size(183, 21);
			...
			this.butRefresh.Location = new System.Drawing.Point(834, 1);
			...
			this.grid.Size = new System.Drawing.Size(909, 578);
		...
		private void FillGrid() {
			...
			if(comboPermission.SelectedIndex==0) {
				logList=SecurityLogs.Refresh(PIn.Date(textDateFrom.Text),PIn.Date(textDateTo.Text),
					Permissions.None,PatNum,userNum,PIn.Int(textRows.Text));
			}
			else {
				logList=SecurityLogs.Refresh(PIn.Date(textDateFrom.Text),PIn.Date(textDateTo.Text),
					(Permissions)Enum.Parse(typeof(Permissions),comboPermission.SelectedItem.ToString()),PatNum,userNum,PIn.Int(textRows.Text));
			}
			grid.BeginUpdate();
			grid.Columns.Clear();
			...
			grid.Columns.Add(new ODGridColumn(Lan.g("TableAudit","Log Text"),330));
			grid.Rows.Clear();
			ODGridRow row;
