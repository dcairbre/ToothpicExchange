...
namespace xCrudGenerator {
	public class CrudGenDataInterface {
		...
		private class "+typeClassName+"Cache : CacheAbs<"+typeClassName+@"> {
			...
			protected override bool IsInListShort("+typeClassName+" "+obj+@") {
		...
		///<summary>A list of all "+SName+@". Returns a deep copy.</summary>
		public static List<"+typeClassName+@"> ListDeep {
			get {
				return _"+obj+@"Cache.ListDeep;
			}
		}

		///<summary>A list of all non-hidden "+GetSname(typeClassName)+@". Returns a deep copy.</summary>
		public static List<"+typeClassName+@"> ListShortDeep {
			get {
				return _"+obj+@"Cache.ListShortDeep;
			}
		}

		///<summary>A list of all "+GetSname(typeClassName)+@". Returns a shallow copy.</summary>
		public static List<"+typeClassName+@"> ListShallow {
			get {
				return _"+obj+@"Cache.ListShallow;
			}
		}

		///<summary>A list of all non-hidden "+GetSname(typeClassName)+@". Returns a shallow copy.</summary>
		public static List<"+typeClassName+@"> ListShortShallow {
			get {
				return _"+obj+@"Cache.ListShallowShort;
			}
		}
