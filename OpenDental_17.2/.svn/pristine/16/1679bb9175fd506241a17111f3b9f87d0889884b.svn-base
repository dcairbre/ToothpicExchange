...
namespace OpenDental{
	...
	public class FormStatementOptions : ODForm {
		...
		private void InitializeComponent()
		{
			...
			this.butCancel.Location = new System.Drawing.Point(616, 539);
			...
			this.butOK.Location = new System.Drawing.Point(532, 539);
			...
			this.butDelete.Location = new System.Drawing.Point(18, 539);
			...
			this.butPrint.Location = new System.Drawing.Point(163, 539);
			...
			this.butEmail.Location = new System.Drawing.Point(248, 539);
			...
			this.butPreview.Location = new System.Drawing.Point(416, 539);
			...
			this.butPatPortal.Location = new System.Drawing.Point(332, 539);
			this.butPatPortal.Name = "butPortal";
		...
		private void butPrintSheets() {
				...
				&& !StmtCur.IsInvoice)//Invoices are always recreated on the fly in order to show "Copy" when needed.
			{
				...
				if(checkSuperStatement.Checked) {
					...
					dataSet=AccountModules.GetSuperFamAccount(StmtCur);
				}
				else {
		...
		private void butPatPortal_Click(object sender,EventArgs e) {
			if(!DefC.GetList(DefCat.ImageCats).Any(x => x.ItemValue.Contains(ImageCategorySpecial.L.ToString()) 
