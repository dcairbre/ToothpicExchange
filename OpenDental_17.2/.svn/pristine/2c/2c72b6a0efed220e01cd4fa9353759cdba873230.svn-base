...
namespace OpenDentBusiness{
	...
	public class GroupPermissions {
		...
		public static List<GroupPermission> GetPermsForReports() {
			return GroupPermissionC.List.ToList().FindAll(x => x.PermType==Permissions.Reports && x.FKey!=0);
		}
		...
		public static bool HasPermission(long userGroupNum,Permissions permType,long fKey){
			//No need to check RemotingRole; no call to db.
			for(int i=0;i<GroupPermissionC.List.Length;i++){
				if(GroupPermissionC.List[i].UserGroupNum!=userGroupNum || GroupPermissionC.List[i].PermType!=permType || GroupPermissionC.List[i].FKey!=fKey){
					continue;
				}
				return true;
			}
		...
		public static string GetDesc(Permissions perm){
			...
			switch(perm){
				...
				case Permissions.ApptConfirmStatusEdit:
					return Lans.g("enumPermissions","Appointment Confirmation Status Edit");
				case Permissions.AutoNoteQuickNoteEdit:
				...
				case Permissions.AuditTrail:
					return Lans.g("enumPermissions","Audit Trail");
				case Permissions.Backup:
				...
				case Permissions.ClaimProcClaimAttachedProvEdit:
					return Lans.g("enumPermissions","Claim Procedure Provider Edit When Attached to Claim");
				case Permissions.ClaimProcReceivedEdit:
					return Lans.g("enumPermissions","Claim Procedure Received Edit");
				case Permissions.ClaimSend:
				...
				case Permissions.GraphicsEdit:
					return Lans.g("enumPermissions","Graphics Edit");
				case Permissions.GroupNoteEditSigned:
					return Lans.g("enumPermissions","Group Note Edit (other users, signed)");
				case Permissions.ImageDelete:
				...
				case Permissions.InsPlanOrthoEdit:
					return Lans.g("enumPermissions","Insurance Plan Ortho Edit");
				case Permissions.InsPlanPickListExisting:
					return Lans.g("enumPermissions","Change existing Ins Plan using Pick From List");
				case Permissions.InsPlanVerifyList:
					return Lans.g("enumPermissions","Insurance Plan Verification Assign");
				case Permissions.InsWriteOffEdit:
				...
				case Permissions.MobileWeb:
					return Lans.g("enumPermissions","Mobile Web");
				case Permissions.None:
					return "";
				case Permissions.OrthoChartEditFull:
					return Lans.g("enumPermissions","Ortho Chart Edit (full)");
				case Permissions.OrthoChartEditUser:
					return Lans.g("enumPermissions","Ortho Chart Edit (same user, signed)");
				case Permissions.PatientApptRestrict:
					return Lans.g("enumPermissions","Patient Restriction Edit");
				case Permissions.PatientBillingEdit:
					return Lans.g("enumPermissions","Patient Billing Type Edit");
				case Permissions.PatientCreate:
				...
				case Permissions.PatPriProvEdit:
					return Lans.g("enumPermissions","Patient Primary Provider Edit");
				case Permissions.PaymentCreate:
				...
				case Permissions.PopupEdit:
					return Lans.g("enumPermissions","Popup Edit (other users)");
				case Permissions.ProblemEdit:
					return Lans.g("enumPermissions","Problem Edit");
				case Permissions.ProcComplCreate:
					return Lans.g("enumPermissions","Create Completed Procedure (or set complete)");
				case Permissions.ProcedureNoteFull:
					return Lans.g("enumPermissions","Procedure Note (full)");
				case Permissions.ProcedureNoteUser:
					return Lans.g("enumPermissions","Procedure Note (same user)");
				case Permissions.ProcDelete:
				...
				case Permissions.ProviderAlphabetize:
					return Lans.g("enumPermissions","Providers - Alphabetize");
				case Permissions.ProviderFeeEdit:
				...
				case Permissions.ReportDaily:
					return Lans.g("enumPermissions","Reports - Daily");
				case Permissions.ReportDailyAllProviders:
					return Lans.g("enumPermissions","Daily Payments - View All Providers");
				case Permissions.ReportProdInc:
					return Lans.g("enumPermissions","Reports - Production and Income, Aging");
				case Permissions.ReportProdIncAllProviders:
					return Lans.g("enumPermissions","Production and Income - View All Providers");
				...
				case Permissions.SheetDelete:
					return Lans.g("enumPermissions","Sheet Delete");
				case Permissions.SheetEdit:
				...
				case Permissions.TreatPlanPresenterEdit:
					return Lans.g("enumPermissions","Edit Treatment Plan Presenter");
				case Permissions.UpdateCustomTracking:
					return Lans.g("enumPermissions","Update Custom Tracking");
				case Permissions.UserQuery:
				...
				case Permissions.InsPlanMerge:
					return Lans.g("enumPermissions","Insurance Plan Combine");
				case Permissions.InsCarrierCombine:
					return Lans.g("enumPermissions","Insurance Carrier Combine");
			}
