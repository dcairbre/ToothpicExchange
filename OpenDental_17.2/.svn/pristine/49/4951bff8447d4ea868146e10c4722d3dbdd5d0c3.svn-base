...
namespace OpenDental{
	...
	public class FormPerio : ODForm {
		...
		///<summary>A stale, deep copy of all procedure codes in the cache that was filled on load.  
		///Used to determine if a tooth had an implant procedure on it.</summary>
