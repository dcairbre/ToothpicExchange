...
///<summary>All this dialog does is set the patnum and it is up to the calling form to do an immediate refresh, or possibly just change the patnum back to what it was.  So the other patient fields must remain intact during all logic in this form, especially if SelectionModeOnly.</summary>
	public class FormPatientSelect : ODForm{
		...
		private void InitializeComponent()
		{
			...
			// textRegKey
			// 
			this.textRegKey.Location = new System.Drawing.Point(166, 289);
			...
			// labelRegKey
			// 
			this.labelRegKey.Location = new System.Drawing.Point(11, 290);
			...
			this.comboClinic.Location = new System.Drawing.Point(98, 352);
			...
			// labelClinic
			// 
			this.labelClinic.Location = new System.Drawing.Point(11, 356);
			...
			// textCountry
			// 
			this.textCountry.Location = new System.Drawing.Point(166, 269);
			...
			// labelCountry
			// 
			this.labelCountry.Location = new System.Drawing.Point(11, 270);
			...
			this.comboSite.Location = new System.Drawing.Point(98, 331);
			...
			// labelSite
			// 
			this.labelSite.Location = new System.Drawing.Point(11, 335);
			...
			this.comboBillingType.Location = new System.Drawing.Point(98, 310);
			...
			this.checkShowArchived.Location = new System.Drawing.Point(11, 414);
			...
			this.checkGuarantors.Location = new System.Drawing.Point(11, 380);
			...
			this.checkHideInactive.Location = new System.Drawing.Point(11, 397);
		...
		private void FillGrid(bool limit,List<long> explicitPatNums=null) {
			...
			if(!PrefC.GetBool(PrefName.EasyNoClinics)) {
				if(comboClinic.SelectedIndex==0) {//'All' is selected
					...
					clinicNums=_listClinics.Find(x => x.Abbr==comboClinic.Items[comboClinic.SelectedIndex].ToString()).ClinicNum.ToString();
		...
		private void butAddPt_Click(object sender, System.EventArgs e){
			...
			if(!PrefC.GetBool(PrefName.PriProvDefaultToSelectProv)) {
				...
				if(PrefC.HasClinicsEnabled && comboClinic.SelectedIndex!=0) {//clinics enabled and all isn't selected
					...
					Provider prov=Providers.GetDefaultProvider(_listClinics.Find(x => x.Abbr==comboClinic.Items[comboClinic.SelectedIndex].ToString()).ClinicNum);
					if(prov!=null) {
