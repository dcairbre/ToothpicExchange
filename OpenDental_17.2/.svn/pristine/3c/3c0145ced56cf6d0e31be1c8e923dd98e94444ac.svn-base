...
///<summary></summary>
    ...
    "delete unused computer names from this list to speed up messaging.";
		...
		private void listComputer_MouseDoubleClick(object sender,MouseEventArgs e) {
			...
			FormG.ComputerPrefCur=ComputerPrefs.GetForComputer(Computers.List[listComputer.SelectedIndex].CompName);
			FormG.ShowDialog();
		}
		...
		private void butSetSimpleGraphics_Click(object sender,EventArgs e) {
			...
			SecurityLogs.MakeLogEntry(Permissions.GraphicsEdit,0,"Set the graphics for computer "+Computers.List[listComputer.SelectedIndex].CompName+" to simple");
		}
