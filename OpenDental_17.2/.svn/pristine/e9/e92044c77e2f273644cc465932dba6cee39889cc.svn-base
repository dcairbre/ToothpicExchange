...
namespace OpenDental{
	...
	public class FormCarrierEdit : ODForm {
		...
		private TextBox textCarrierGroup;
		...
		private void InitializeComponent()
		{
			...
			this.textCarrierGroup = new System.Windows.Forms.TextBox();
			...
			this.checkIsCDAnet.Location = new System.Drawing.Point(30, 254);
    ...
    "tting the carrier identification number above.";
			...
			this.checkIsHidden.Location = new System.Drawing.Point(88, 177);
			...
			this.butDelete.Location = new System.Drawing.Point(29, 514);
			...
			this.butOK.Location = new System.Drawing.Point(512, 513);
			...
			this.butCancel.Location = new System.Drawing.Point(614, 513);
			...
			// textCarrierGroup
			// 
			this.textCarrierGroup.Location = new System.Drawing.Point(179, 150);
			this.textCarrierGroup.MaxLength = 255;
			this.textCarrierGroup.Name = "textCarrierGroup";
			this.textCarrierGroup.Size = new System.Drawing.Size(226, 20);
			this.textCarrierGroup.TabIndex = 98;
			// 
			// label15
			// 
			...
			this.label15.Text = "Carrier Group";
			this.label15.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// FormCarrierEdit
			// 
			this.ClientSize = new System.Drawing.Size(722, 547);
			this.Controls.Add(this.textCarrierGroup);
		...
		private void FormCarrierEdit_Load(object sender, System.EventArgs e) {
			...
			textCarrierGroup.Text=CarrierCur.CarrierGroupName;
			...
			if(CultureInfo.CurrentCulture.Name.EndsWith("CA")) {//Canadian. en-CA or fr-CA
				...
				this.Size=new Size(525,330);//make it smaller
			}
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			CarrierCur.CarrierGroupName=textCarrierGroup.Text;
