...
namespace OpenDentBusiness {
	public class RpProdInc {
		...
		public static DataSet GetDailyData(DateTime dateFrom,DateTime dateTo,List<Provider> listProvs,List<Clinic> listClinics,bool writeOffPay,bool hasAllProvs,bool hasAllClinics,bool hasBreakdown,bool hasClinicInfo,bool addUnearnedCEMT = false) {
      ...
      if(!hasClinicInfo) {
        _hasClinics=false;
			...
			DataSet dataSet=GetDailyProdIncDataSet(dateFrom,dateTo,listProvs,listClinics,writeOffPay,hasAllProvs,hasAllClinics,addUnearnedCEMT);
		...
		public static DataSet GetProviderDataForClinics(DateTime dateFrom,DateTime dateTo,List<Provider> listProvs,List<Clinic> listClinics,bool writeOffPay,bool hasAllProvs,bool hasAllClinics,bool addUnearnedCEMT=false) {
			if(listClinics.Count>0) {
				_hasClinics=true;
			}
			DataSet dataSet=GetDailyProdIncDataSet(dateFrom,dateTo,listProvs,listClinics,writeOffPay,hasAllProvs,hasAllClinics,addUnearnedCEMT);
		...
		public static DataSet GetDailyProdIncDataSet(DateTime dateFrom,DateTime dateTo,List<Provider> listProvs,List<Clinic> listClinics,bool writeOffPay,bool hasAllProvs,bool hasAllClinics,bool addUnearnedCEMT) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetDS(MethodBase.GetCurrentMethod(),dateFrom,dateTo,listProvs,listClinics,writeOffPay,hasAllProvs,hasAllClinics,addUnearnedCEMT);
			}
			...
			DataTable tableProduction=ReportsComplex.RunFuncOnReportServer(() => Db.GetTable(command));
			...
			command="SELECT "
				...
				+"WHERE adjustment.AdjDate >= "+POut.Date(dateFrom)+" "
					...
					+whereClin+" "
				+"ORDER BY Date,namelf";
			DataTable tableAdj = ReportsComplex.RunFuncOnReportServer(() => Db.GetTable(command));
			...
			DataTable tableInsWriteoff=ReportsComplex.RunFuncOnReportServer(() => Db.GetTable(command));
			...
			command="SELECT "
				...
				+"ORDER BY Date,namelf";
			DataTable tablePay=ReportsComplex.RunFuncOnReportServer(() => Db.GetTable(command));
			...
			command="SELECT "
				...
				+"ORDER BY Date,namelf";
			DataTable tableIns=ReportsComplex.RunFuncOnReportServer(() => Db.GetTable(command));
		...
		public static DataSet GetMonthlyData(DateTime dateFrom,DateTime dateTo,List<Provider> listProvs,List<Clinic> listClinics,bool writeOffPay,bool hasAllProvs,bool hasAllClinics,bool addUnearnedCEMT=false) {
			//No need to check RemotingRole; no call to db.
			if(listClinics.Count>0) {
				_hasClinics=true;
			}
			DataSet dataSet=GetMonthlyProdIncDataSet(dateFrom,dateTo,listProvs,listClinics,writeOffPay,hasAllProvs,hasAllClinics,addUnearnedCEMT);
			DataTable tableProduction=dataSet.Tables["tableProduction"];
			DataTable tableAdj=dataSet.Tables["tableAdj"];
			DataTable tableInsWriteoff=dataSet.Tables["tableInsWriteoff"];
			DataTable tablePay=dataSet.Tables["tablePay"];
		...
		public static DataSet GetMonthlyProdIncDataSet(DateTime dateFrom,DateTime dateTo,List<Provider> listProvs,List<Clinic> listClinics,bool writeOffPay,bool hasAllProvs,bool hasAllClinics,bool addUnearnedCEMT) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetDS(MethodBase.GetCurrentMethod(),dateFrom,dateTo,listProvs,listClinics,writeOffPay,hasAllProvs,hasAllClinics,addUnearnedCEMT);
			}
			List<long> listClinicNums=new List<long>();
		...
		public static DataSet GetAnnualData(DateTime dateFrom,DateTime dateTo,List<Provider> listProvs,List<Clinic> listClinics,bool writeOffPay,bool hasAllProvs,bool hasAllClinics,bool addUnearnedCEMT=false) {
			//No need to check RemotingRole; no call to db.
			if(listClinics.Count>0) {
				_hasClinics=true;
			}
			DataSet dataSet=GetAnnualProdIncDataSet(dateFrom,dateTo,listProvs,listClinics,writeOffPay,hasAllProvs,hasAllClinics,addUnearnedCEMT);
			DataTable tableProduction=dataSet.Tables["tableProduction"];
			DataTable tableAdj=dataSet.Tables["tableAdj"];
			DataTable tableInsWriteoff=dataSet.Tables["tableInsWriteoff"];
			DataTable tablePay=dataSet.Tables["tablePay"];
			DataTable tableIns=dataSet.Tables["tableIns"];
			DataTable tableWriteOffAccrual=dataSet.Tables["tableWriteOffAccrual"];
			decimal production;
			decimal adjust;
			decimal inswriteoff;	//spk 5/19/05
			decimal totalproduction;
		...
		/// Does not work for Oracle (by chance not by design). Consider enhancing with DbHelper.Year(),DbHelper.Month(), DbHelper.Day() and enhancing the GroupBy Logic.</summary>
		public static DataSet GetAnnualProdIncDataSet(DateTime dateFrom,DateTime dateTo,List<Provider> listProvs,List<Clinic> listClinics,bool writeOffPay,bool hasAllProvs,bool hasAllClinics,bool addUnearnedCEMT) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetDS(MethodBase.GetCurrentMethod(),dateFrom,dateTo,listProvs,listClinics,writeOffPay,hasAllProvs,hasAllClinics,addUnearnedCEMT);
			}
			List<long> listClinicNums=new List<long>();
