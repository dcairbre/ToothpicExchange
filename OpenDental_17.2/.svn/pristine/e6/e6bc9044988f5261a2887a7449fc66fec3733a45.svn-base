...
namespace OpenDentBusiness{
	...
	public class ClaimTracking:TableBase{
		...
		///<summary>FKey to claim.ClaimNum</summary>
		...
		///<summary>FKey to user.UserNum</summary>
		public long UserNum;
		...
		public string Note;
		///<summary>FKey to definition.DefNum for custom tracking when TrackingType=StatusHistory</summary>
		public long TrackingDefNum;
		///<summary>FKey to definition.DefNum for custom tracking errors when TrackingType=StatusHistory</summary>
