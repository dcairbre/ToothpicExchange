...
namespace OpenDental
{
	...
	public class FormPaySplitEdit : ODForm
	{
		...
		private void InitializeComponent(){
			...
			this.groupPatient.Location = new System.Drawing.Point(480, 4);
			...
			this.butEditAnyway.Location = new System.Drawing.Point(670, 176);
		...
		private void FillProcedure(){
			...
			if(IsNew) {//This is temporary until we add in a security permission to allow users to edit providers of paysplits that have procedures attached.
				comboProvider.Enabled=false;
				comboClinic.Enabled=false;
			}
			comboUnearnedTypes.Enabled=false;
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			if(PaySplitCur.ProvNum==0 && ProcCur!=null && !_isEditAnyway) {
      ...
      if(ProcCur==null
        && PaySplitCur.ProvNum>0 //not unallocated
		...
		private void FormPaySplitEdit_FormClosing(object sender,FormClosingEventArgs e) {
			...
			PaySplitCur.PrepaymentNum=_paySplitCopy.PrepaymentNum;
