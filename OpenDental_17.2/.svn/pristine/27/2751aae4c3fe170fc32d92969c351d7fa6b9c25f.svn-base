...
namespace OpenDental{
	...
	public class FormClearinghouseEdit : ODForm {
		...
		///<summary>When enabled we can attempted to retrieve 835s.  Only used by specific clearinghouses.</summary>
		private CheckBox checkIsEraDownloadAllowed;
		...
		private void InitializeComponent()
		{
			...
			this.checkIsEraDownloadAllowed = new System.Windows.Forms.CheckBox();
    ...
    "nassigned/Default is selected.";
			...
			// 
			// checkIsEraDownloadAllowed
			// 
			this.checkIsEraDownloadAllowed.CheckAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkIsEraDownloadAllowed.Checked = true;
			this.checkIsEraDownloadAllowed.CheckState = System.Windows.Forms.CheckState.Checked;
			this.checkIsEraDownloadAllowed.Enabled = false;
			this.checkIsEraDownloadAllowed.Location = new System.Drawing.Point(583, 434);
			this.checkIsEraDownloadAllowed.Name = "checkIsEraDownloadAllowed";
			this.checkIsEraDownloadAllowed.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.checkIsEraDownloadAllowed.Size = new System.Drawing.Size(363, 20);
			this.checkIsEraDownloadAllowed.TabIndex = 17;
			this.checkIsEraDownloadAllowed.Text = "Allow ERA Download";
			this.checkIsEraDownloadAllowed.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			this.checkIsEraDownloadAllowed.UseVisualStyleBackColor = true;
			// 
			...
			this.checkIsClaimExportAllowed.Location = new System.Drawing.Point(583, 413);
			...
			this.Controls.Add(this.checkIsEraDownloadAllowed);
		...
		private void FillFields() {
			...
			if(ClearinghouseCur.CommBridge.In(EclaimsCommBridge.EDS,EclaimsCommBridge.Claimstream,EclaimsCommBridge.ITRANS)) {
				checkIsEraDownloadAllowed.Enabled=true;
				checkIsEraDownloadAllowed.Checked=ClearinghouseCur.IsEraDownloadAllowed;
				...
				if(ClearinghouseCur.CommBridge.In(EclaimsCommBridge.Claimstream,EclaimsCommBridge.ITRANS)) {
					checkIsEraDownloadAllowed.Text=Lan.g(this,"Automatically enter payment amounts from EOB responses.");
				}
			}		
		}
		...
		private bool SaveToCache() {
			...
			if(ClinicNum==0) {
				...
				ClearinghouseHq.IsEraDownloadAllowed=checkIsEraDownloadAllowed.Checked;
				...
				ClearinghouseClin.IsEraDownloadAllowed=checkIsEraDownloadAllowed.Checked;
		...
		private void comboCommBridge_SelectionChangeCommitted(object sender,EventArgs e) {
			checkIsEraDownloadAllowed.Enabled=(comboCommBridge.SelectedIndex.In((int)EclaimsCommBridge.EDS,(int)EclaimsCommBridge.Claimstream,(int)EclaimsCommBridge.ITRANS));
