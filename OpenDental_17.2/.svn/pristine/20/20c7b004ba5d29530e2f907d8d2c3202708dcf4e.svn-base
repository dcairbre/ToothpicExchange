...
namespace OpenDental{
	...
	public class FormDiseaseDefs:ODForm {
		...
		private void InitializeComponent()
		{
			...
			this.textSnoMed.QuickPasteType = OpenDentBusiness.QuickPasteType.None;
			...
			this.textICD10.QuickPasteType = OpenDentBusiness.QuickPasteType.None;
			...
			this.textICD9.QuickPasteType = OpenDentBusiness.QuickPasteType.None;
		...
		private void butAdd_Click(object sender,System.EventArgs e) {
			...
			DiseaseDef def=new DiseaseDef() {
				...
				Icd10Code="",
				SnomedCode="",
				ItemOrder=DiseaseDefs.ListLong.Length
			};
