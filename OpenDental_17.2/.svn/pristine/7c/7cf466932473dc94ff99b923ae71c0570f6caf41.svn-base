namespace OpenDental.UI {
	partial class ODDateRangePicker {
		...
		private void InitializeComponent() {
			...
			this.butWeekPrevious.TabIndex = 69;
			...
			this.butDropTo.Click += new System.EventHandler(this.butToggleCalendar_Click);
			// 
			// butDropFrom
			// 
			...
			this.butDropFrom.Click += new System.EventHandler(this.butToggleCalendar_Click);
			// 
			// ODDateRangePicker
			// 
		...
		private PanelOD panelCalendarGap;
		private PanelOD panelCalendarBoarders;
		private PanelOD panelMidLines;
		private PanelOD panelWeek;
		private System.Windows.Forms.ImageList imageListCalendar;
		private Button butWeekPrevious;
		private Button butWeekNext;
		private Button butDropTo;
		private Button butDropFrom;
	}
}
