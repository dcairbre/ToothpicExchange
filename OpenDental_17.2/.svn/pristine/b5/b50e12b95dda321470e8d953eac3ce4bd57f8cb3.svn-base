namespace OpenDental {
	partial class FormMapSetup {
		...
		private void InitializeComponent() {
			...
			this.textExtensionEnd = new OpenDental.ValidNumber();
			this.textExtensionStart = new OpenDental.ValidNumber();
			...
			this.gridEmployees.Location = new System.Drawing.Point(1392, 219);
			this.gridEmployees.Name = "gridEmployees";
			this.gridEmployees.ScrollValue = 0;
			this.gridEmployees.Size = new System.Drawing.Size(182, 709);
			...
			this.butAddRoom.TabIndex = 55;
			this.butAddRoom.Text = "Add Room";
			this.butAddRoom.Click += new System.EventHandler(this.butAddRoom_Click);
			// 
			// textExtensionEnd
			// 
			this.textExtensionEnd.Location = new System.Drawing.Point(1505, 197);
			this.textExtensionEnd.MaxVal = 1000000;
			this.textExtensionEnd.MinVal = 0;
			this.textExtensionEnd.Name = "textExtensionEnd";
			this.textExtensionEnd.Size = new System.Drawing.Size(66, 20);
			this.textExtensionEnd.TabIndex = 60;
			this.textExtensionEnd.Leave += new System.EventHandler(this.textExtensionEnd_Leave);
			// 
			// textExtensionStart
			// 
			this.textExtensionStart.Location = new System.Drawing.Point(1505, 176);
			this.textExtensionStart.MaxVal = 1000000;
			this.textExtensionStart.MinVal = 0;
			this.textExtensionStart.Name = "textExtensionStart";
			this.textExtensionStart.Size = new System.Drawing.Size(66, 20);
			this.textExtensionStart.TabIndex = 59;
			this.textExtensionStart.Leave += new System.EventHandler(this.textExtensionStart_Leave);
			// 
			// label6
			// 
			this.label6.Location = new System.Drawing.Point(1396, 176);
			this.label6.Name = "label6";
			this.label6.Size = new System.Drawing.Size(104, 16);
			this.label6.TabIndex = 57;
			this.label6.Text = "Extensions Start";
			this.label6.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// label7
			// 
			this.label7.Location = new System.Drawing.Point(1396, 197);
			this.label7.Name = "label7";
			this.label7.Size = new System.Drawing.Size(104, 16);
			this.label7.TabIndex = 58;
			this.label7.Text = "Entensions End";
			...
			this.Controls.Add(this.textExtensionEnd);
			this.Controls.Add(this.textExtensionStart);
		...
		private ValidNumber textExtensionEnd;
		private ValidNumber textExtensionStart;
