...
namespace OpenDental {
	...
	public partial class SetupWizard {
		...
		public class ClinicSetup:SetupWizClass {
			...
			public override ODSetupStatus GetStatus {
				get {
					List<Clinic> listClinics = Clinics.GetListShort();
		...
		public class ProvSetup:SetupWizClass {
			...
			public override ODSetupStatus GetStatus {
				get {
					List<Provider> listProviders = ProviderC.ListShort;
			...
			public static bool IsPrimary(Provider prov) {
				...
				if(DefC.GetName(DefCat.ProviderSpecialties,prov.Specialty).ToLower() == "hygienist"
					|| DefC.GetName(DefCat.ProviderSpecialties,prov.Specialty).ToLower() == "assistant"
					|| DefC.GetName(DefCat.ProviderSpecialties,prov.Specialty).ToLower() == "labtech"
					|| DefC.GetName(DefCat.ProviderSpecialties,prov.Specialty).ToLower() == "other"
					|| DefC.GetName(DefCat.ProviderSpecialties,prov.Specialty).ToLower() == "notes"
					|| DefC.GetName(DefCat.ProviderSpecialties,prov.Specialty).ToLower() == "none"
					) {
					return false;
				}
				if(prov.IsNotPerson) {
		...
		public class OperatorySetup:SetupWizClass {
			...
			public override ODSetupStatus GetStatus {
				get {
					List<Operatory> listOperatories = OperatoryC.ListShort;
		...
		public class EmployeeSetup:SetupWizClass {
			...
			public override ODSetupStatus GetStatus {
				get {
					List<Employee> listEmployees=Employees.GetListShort();
			...
			public override ODSetupStatus GetStatus {
				get {
					...
					if(listSchedule.Count == 0) {
						...
						List<Provider> listProviders = ProviderC.ListShort.Where(x => !x.IsNotPerson).ToList();
						foreach(Provider prov in listProviders) {
