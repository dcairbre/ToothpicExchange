...
namespace OpenDental {
    ...
    "the insurance EOB.";
		...
		private void FormEtrans835ClaimPay_Load(object sender, System.EventArgs e) {
			...
			textEobDedApplied.Text=_claimPaid.PatientDeductAmt.ToString("F");
		...
		private void butOK_Click(object sender,System.EventArgs e) {
			...
			{
				if(MessageBox.Show(Lan.g(this,"Some of the EOB totals do not match the totals entered")+".  "+Lan.g(this,"Continue")+"?",
					"",MessageBoxButtons.OKCancel)!=DialogResult.OK)
				{
					return;
				}
