...
namespace OpenDentBusiness.Crud{
	public class SheetCrud {
		...
		public static long Insert(Sheet sheet,bool useExistingPK){
			...
			command+="SheetType,PatNum,DateTimeSheet,FontSize,FontName,Width,Height,IsLandscape,InternalNote,Description,ShowInTerminal,IsWebForm,IsMultiPage,IsDeleted,SheetDefNum) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
