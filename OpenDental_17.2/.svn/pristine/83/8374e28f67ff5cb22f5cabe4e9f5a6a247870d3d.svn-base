	...
	public class SheetFieldsAvailable {
		...
		private static List<SheetFieldDef> GetRxMulti(OutInCheck outInCheck) {
			...
			if(outInCheck==OutInCheck.Out) {
				...
				list.Add(NewOutput("prov.address"));
				list.Add(NewOutput("prov.address2"));
				list.Add(NewOutput("prov.address3"));
				list.Add(NewOutput("prov.address4"));
				list.Add(NewOutput("prov.address5"));
				list.Add(NewOutput("prov.address6"));
				list.Add(NewOutput("prov.cityStateZip"));
				list.Add(NewOutput("prov.cityStateZip2"));
				list.Add(NewOutput("prov.cityStateZip3"));
				list.Add(NewOutput("prov.cityStateZip4"));
				list.Add(NewOutput("prov.cityStateZip5"));
				list.Add(NewOutput("prov.cityStateZip6"));
				list.Add(NewOutput("prov.phone"));
				list.Add(NewOutput("prov.phone2"));
				list.Add(NewOutput("prov.phone3"));
				list.Add(NewOutput("prov.phone4"));
				list.Add(NewOutput("prov.phone5"));
				list.Add(NewOutput("prov.phone6"));
				list.Add(NewOutput("prov.stateRxID"));
