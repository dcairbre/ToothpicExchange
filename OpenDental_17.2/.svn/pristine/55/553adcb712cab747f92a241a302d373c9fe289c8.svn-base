...
///<summary></summary>
	public class FormMedical : ODForm {
		...
		private void FillMeds(bool isForPrinting = false) {
			...
			int colRemainder=(isForPrinting?gridToFill.Width:(tabControlFormMedical.Width-20))-200-19-45-(CDSPermissions.GetForUser(Security.CurUser.UserNum).ShowInfobutton?18:0);
			col=new ODGridColumn(Lan.g("TableMedications","Medication"),200);
			gridToFill.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableMedications","Notes"),colRemainder/2);
			gridToFill.Columns.Add(col);
			col=new ODGridColumn(Lan.g("TableMedications","Notes for Patient"),colRemainder/2);
			gridToFill.Columns.Add(col);
