...
namespace OpenDental {
	public partial class FormTrackNextSetup:ODForm {
		...
		private void FormTrackNextSetup_Load(object sender,EventArgs e) {
			Dictionary<string,Pref> dictPref=PrefC.GetDict();
			textDaysPast.Text=PrefC.GetLong(PrefName.PlannedApptDaysPast,dictPref).ToString();
			textDaysFuture.Text=PrefC.GetLong(PrefName.PlannedApptDaysFuture,dictPref).ToString();
		}
