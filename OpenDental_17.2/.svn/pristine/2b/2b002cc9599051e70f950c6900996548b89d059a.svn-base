...
namespace OpenDental{
	...
	///<summary>A wrapper class around FormProgressStatus so that other engineers are not responsible for managing their own progress thread.</summary>
	public class ODProgress {
		...
		public static Action ShowProgressStatus(string eventName,string startingMessage="Please Wait...",bool hasMinimize=true) {
			return ShowProgressStatus(eventName,typeof(ODEvent),false,hasMinimize,startingMessage);
		}
		...
		public static Action ShowProgressStatus(string eventName,Type eventType,bool hasHistory=false,bool hasMinimize=true,object tag=null) {
