			...
			if(DataConnection.DBtype==DatabaseType.Oracle || PrefC.RandomKeys) {
				...
				while(index < listRecalls.Count) {
					...
					if(sbCommands==null) {
						...
						sbCommands.Append("PatNum,DateDueCalc,DateDue,DatePrevious,RecallInterval,RecallStatus,Note,IsDisabled,RecallTypeNum,DisableUntilBalance,DisableUntilDate,DateScheduled) VALUES ");
					}
					else {
						hasComma=true;
					}
