...
///<summary></summary>
	public class FormClaimPayEdit:ODForm {
		...
		private void InitializeComponent(){
			...
			// textAmount
			// 
			this.textAmount.Location = new System.Drawing.Point(129, 135);
			...
			// textDate
			// 
			this.textDate.Location = new System.Drawing.Point(129, 93);
			...
			// textBankBranch
			// 
			this.textBankBranch.Location = new System.Drawing.Point(129, 177);
			...
			// textCheckNum
			// 
			this.textCheckNum.Location = new System.Drawing.Point(129, 156);
			...
			// textNote
			// 
			this.textNote.Location = new System.Drawing.Point(129, 247);
			...
			this.butCancel.Location = new System.Drawing.Point(414, 396);
			...
			this.butOK.Location = new System.Drawing.Point(323, 396);
			...
			// textCarrierName
			// 
			this.textCarrierName.Location = new System.Drawing.Point(129, 198);
			...
			// labelDateIssued
			// 
			this.labelDateIssued.Location = new System.Drawing.Point(7, 118);
			...
			// textDateIssued
			// 
			this.textDateIssued.Location = new System.Drawing.Point(129, 114);
			...
			this.butCarrierSelect.Location = new System.Drawing.Point(395, 196);
			...
			// label8
			// 
			this.label8.Location = new System.Drawing.Point(126, 221);
			...
			// label9
			// 
			this.label9.Location = new System.Drawing.Point(232, 178);
			...
			// label10
			// 
			this.label10.Location = new System.Drawing.Point(232, 157);
			...
			this.butPickPaymentGroup.Location = new System.Drawing.Point(339, 67);
			...
			this.comboPayGroup.Location = new System.Drawing.Point(129, 67);
			...
			this.groupPrepaid.Location = new System.Drawing.Point(129, 326);
			...
			this.butPayConnect.Location = new System.Drawing.Point(88, 23);
		...
		private void FormClaimPayEdit_Load(object sender, System.EventArgs e) {
			...
			_listCPGroups=DefC.GetList(DefCat.ClaimPaymentGroups).ToList();
		...
		private void panelXcharge_MouseClick(object sender,MouseEventArgs e) {
			...
			FormPayment form=new FormPayment(new Patient(),new Family(),pay);
			try {
				...
				MessageBox.Show(Lan.g(this,"Error processing transaction.\r\n\r\nPlease contact support with the following information:")
					...
					+"\r\nLast valid milestone reached: "+form.XchargeMilestone
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			long selectedClaimPayGroupNum=0;
			selectedClaimPayGroupNum=DefC.GetList(DefCat.ClaimPaymentGroups)[comboPayGroup.SelectedIndex].DefNum;
			ClaimPaymentCur.PayType=(DefC.GetList(DefCat.InsurancePaymentType)[comboPayType.SelectedIndex].DefNum);
			ClaimPaymentCur.PayGroup=selectedClaimPayGroupNum;
