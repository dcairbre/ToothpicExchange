...
namespace OpenDental {
	public partial class FormApptTypes:ODForm {
		...
		private void FormApptTypes_Load(object sender,EventArgs e) {
			...
			if(SelectionMode) { //don't show hidden appointment types in selection mode
				_listApptTypes=AppointmentTypes.ListShort;
			}
			else {
				_listApptTypes=AppointmentTypes.Listt;
			}
			_listApptTypesOld=AppointmentTypes.ListDeep;
			FillMain();
		}
