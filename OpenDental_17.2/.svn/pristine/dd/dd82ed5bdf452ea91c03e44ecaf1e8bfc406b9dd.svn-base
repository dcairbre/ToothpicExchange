...
namespace OpenDentBusiness.Crud{
	public class WebSchedRecallCrud {
		...
		public static long Insert(WebSchedRecall webSchedRecall,bool useExistingPK){
			...
			OdSqlParameter paramMsgTextToMobileTemplate=new OdSqlParameter("paramMsgTextToMobileTemplate",OdDbType.Text,webSchedRecall.MsgTextToMobileTemplate);
			if(webSchedRecall.MsgTextToMobile==null) {
				webSchedRecall.MsgTextToMobile="";
			}
			OdSqlParameter paramMsgTextToMobile=new OdSqlParameter("paramMsgTextToMobile",OdDbType.Text,webSchedRecall.MsgTextToMobile);
			if(webSchedRecall.EmailSubjTemplate==null) {
				webSchedRecall.EmailSubjTemplate="";
			}
			OdSqlParameter paramEmailSubjTemplate=new OdSqlParameter("paramEmailSubjTemplate",OdDbType.Text,webSchedRecall.EmailSubjTemplate);
			if(webSchedRecall.EmailSubj==null) {
				webSchedRecall.EmailSubj="";
			}
			OdSqlParameter paramEmailSubj=new OdSqlParameter("paramEmailSubj",OdDbType.Text,webSchedRecall.EmailSubj);
			if(webSchedRecall.EmailTextTemplate==null) {
				webSchedRecall.EmailTextTemplate="";
			}
			OdSqlParameter paramEmailTextTemplate=new OdSqlParameter("paramEmailTextTemplate",OdDbType.Text,webSchedRecall.EmailTextTemplate);
			if(webSchedRecall.EmailText==null) {
				webSchedRecall.EmailText="";
			}
			OdSqlParameter paramEmailText=new OdSqlParameter("paramEmailText",OdDbType.Text,webSchedRecall.EmailText);
			if(webSchedRecall.GuidMessageToMobile==null) {
				webSchedRecall.GuidMessageToMobile="";
			}
			OdSqlParameter paramGuidMessageToMobile=new OdSqlParameter("paramGuidMessageToMobile",OdDbType.Text,webSchedRecall.GuidMessageToMobile);
			if(webSchedRecall.ResponseDescript==null) {
				webSchedRecall.ResponseDescript="";
			}
			OdSqlParameter paramResponseDescript=new OdSqlParameter("paramResponseDescript",OdDbType.Text,webSchedRecall.ResponseDescript);
			if(useExistingPK || PrefC.RandomKeys) {
				...
				webSchedRecall.WebSchedRecallNum=Db.NonQ(command,true,paramMsgTextToMobileTemplate,paramMsgTextToMobile,paramEmailSubjTemplate,paramEmailSubj,paramEmailTextTemplate,paramEmailText,paramGuidMessageToMobile,paramResponseDescript);
			}
