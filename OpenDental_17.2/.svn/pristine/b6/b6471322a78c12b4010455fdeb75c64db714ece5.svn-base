...
namespace OpenDentBusiness {
	public class PrefC {
		...
		public static int GetInt(PrefName prefName,Dictionary<string,Pref> dictPrefs=null) {
			if(dictPrefs==null) {
				dictPrefs=GetDict();
			}
			if(!dictPrefs.ContainsKey(prefName.ToString())) {
		...
		public static byte GetByte(PrefName prefName,Dictionary<string,Pref> dictPrefs=null) {
			if(dictPrefs==null) {
				dictPrefs=GetDict();
			}
			if(!dictPrefs.ContainsKey(prefName.ToString())) {
		...
		public static double GetDouble(PrefName prefName,Dictionary<string,Pref> dictPrefs=null) {
			if(dictPrefs==null) {
				dictPrefs=GetDict();
			}
			if(!dictPrefs.ContainsKey(prefName.ToString())) {
		...
		public static bool GetBool(PrefName prefName,Dictionary<string,Pref> dictPrefs=null) {
			if(dictPrefs==null) {
				dictPrefs=GetDict();
			}
			if(!dictPrefs.ContainsKey(prefName.ToString())) {
		...
		public static DateTime GetDate(PrefName prefName,Dictionary<string,Pref> dictPrefs=null) {
			if(dictPrefs==null) {
				dictPrefs=GetDict();
			}
			if(!dictPrefs.ContainsKey(prefName.ToString())) {
		...
		public static DateTime GetDateT(PrefName prefName,Dictionary<string,Pref> dictPrefs=null) {
			if(dictPrefs==null) {
				dictPrefs=GetDict();
			}
			if(!dictPrefs.ContainsKey(prefName.ToString())) {
		...
		public static long GetDefaultSheetDefNum(SheetTypeEnum sheetType,Dictionary<string,Pref> dictPrefs=null) {
			if(dictPrefs==null) {
				dictPrefs=GetDict();
			}
			long retVal=0;
			switch(sheetType) {
				case SheetTypeEnum.Consent:
					retVal=GetLong(PrefName.SheetsDefaultConsent,dictPrefs);
					break;
				case SheetTypeEnum.DepositSlip:
					retVal=GetLong(PrefName.SheetsDefaultDepositSlip,dictPrefs);
					break;
				case SheetTypeEnum.ExamSheet:
					retVal=GetLong(PrefName.SheetsDefaultExamSheet,dictPrefs);
					break;
				case SheetTypeEnum.LabelAppointment:
					retVal=GetLong(PrefName.SheetsDefaultLabelAppointment,dictPrefs);
					break;
				case SheetTypeEnum.LabelCarrier:
					retVal=GetLong(PrefName.SheetsDefaultLabelCarrier,dictPrefs);
					break;
				case SheetTypeEnum.LabelPatient:
					retVal=GetLong(PrefName.SheetsDefaultLabelPatient,dictPrefs);
					break;
				case SheetTypeEnum.LabelReferral:
					retVal=GetLong(PrefName.SheetsDefaultLabelReferral,dictPrefs);
					break;
				case SheetTypeEnum.LabSlip:
					retVal=GetLong(PrefName.SheetsDefaultLabSlip,dictPrefs);
					break;
				case SheetTypeEnum.MedicalHistory:
					retVal=GetLong(PrefName.SheetsDefaultMedicalHistory,dictPrefs);
					break;
				case SheetTypeEnum.MedLabResults:
					retVal=GetLong(PrefName.SheetsDefaultMedLabResults,dictPrefs);
					break;
				case SheetTypeEnum.PatientForm:
					retVal=GetLong(PrefName.SheetsDefaultPatientForm,dictPrefs);
					break;
				case SheetTypeEnum.PatientLetter:
					retVal=GetLong(PrefName.SheetsDefaultPatientLetter,dictPrefs);
					break;
				case SheetTypeEnum.PaymentPlan:
					retVal=GetLong(PrefName.SheetsDefaultPaymentPlan,dictPrefs);
					break;
				case SheetTypeEnum.ReferralLetter:
					retVal=GetLong(PrefName.SheetsDefaultReferralLetter,dictPrefs);
					break;
				case SheetTypeEnum.ReferralSlip:
					retVal=GetLong(PrefName.SheetsDefaultReferralSlip,dictPrefs);
					break;
				case SheetTypeEnum.RoutingSlip:
					retVal=GetLong(PrefName.SheetsDefaultRoutingSlip,dictPrefs);
					break;
				case SheetTypeEnum.Rx:
					retVal=GetLong(PrefName.SheetsDefaultRx,dictPrefs);
					break;
				case SheetTypeEnum.RxMulti:
					retVal=GetLong(PrefName.SheetsDefaultRxMulti,dictPrefs);
					break;
				case SheetTypeEnum.Screening:
					retVal=GetLong(PrefName.SheetsDefaultScreening,dictPrefs);
					break;
				case SheetTypeEnum.Statement:
					retVal=GetLong(PrefName.SheetsDefaultStatement,dictPrefs);
					break;
				case SheetTypeEnum.TreatmentPlan:
					retVal=GetLong(PrefName.SheetsDefaultTreatmentPlan,dictPrefs);
					break;
				default:
