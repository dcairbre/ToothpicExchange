...
///<summary></summary>
	public class FormPatientEdit : ODForm {
		...
		private void FormPatientEdit_Load(object sender, System.EventArgs e) {
			...
			comboBillType.IndexSelectOrSetText(DefC.Short[(int)DefCat.BillingTypes].ToList().FindIndex(x => x.DefNum==PatCur.BillingType),
				() => {
					Def billtype = DefC.GetDef(DefCat.BillingTypes,PatCur.BillingType);
					if(billtype != null) {
