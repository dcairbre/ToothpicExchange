...
namespace OpenDentBusiness{
	...
	public class Commlogs {
		...
		public static Commlog InsertForRecall(long patNum,CommItemMode _mode,int numberOfReminders,long defNumNewStatus,CommItemSource commSource,long userNum) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
