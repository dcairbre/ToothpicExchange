...
namespace OpenDentBusiness{
	...
	public class SmsToMobiles{
		...
		*/
		...
		public static bool SendSmsSingle(long patNum,string wirelessPhone,string message,long clinicNum,SmsMessageSource smsMessageSource,bool makeCommLog=true,Userod user=null) {
			//No need to check RemotingRole; no call to db.
