namespace OpenDental.User_Controls.SetupWizard {
	partial class UserControlSetupWizSchedule {
		...
		private void InitializeComponent() {
			...
			this.gridMonday.TranslationName = null;
			// 
			// butAddMonday
			// 
			...
			this.gridSunday.TranslationName = null;
			// 
			// butAddSunday
			// 
			...
			this.gridSaturday.TranslationName = null;
			// 
			// butAddSaturday
			// 
			...
			this.gridFriday.TranslationName = null;
			// 
			// butAddFriday
			// 
			...
			this.gridThursday.TranslationName = null;
			// 
			// butAddThursday
			// 
			...
			this.gridWednesday.TranslationName = null;
			// 
			// butAddWednesday
			// 
			...
			this.gridTuesday.TranslationName = null;
			// 
			// butAddTuesday
			// 
