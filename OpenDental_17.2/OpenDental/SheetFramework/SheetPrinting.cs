...
namespace OpenDental {
	public class SheetPrinting {
		...
		public static void PrintMultiRx(List<Sheet> batchList) {
			PrintBatch(batchList);
		}
		...
		public static void CreatePdf(Sheet sheet,string fullFileName,Statement stmt,DataSet dataSet,MedLab medLab) {
			...
			SheetUtil.CalculateHeights(sheet,dataSet,_stmt,_isPrinting,_printMargin.Top,_printMargin.Bottom,_medLab);
