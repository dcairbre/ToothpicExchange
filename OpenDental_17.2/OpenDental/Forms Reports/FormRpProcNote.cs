...
namespace OpenDental{
	public class FormRpProcNote : ODForm {
		...
		private void ExecuteReport(DateTime dateStart,DateTime dateEnd){
			...
			DataTable dataTable=RpProcNote.GetData(listProvNums,listClinicNums,dateStart,dateEnd,includeNoNotes,includeUnsignedNotes,
			...
			QueryObject query=report.AddQuery(dataTable,"","",SplitByKind.None,1,true);
