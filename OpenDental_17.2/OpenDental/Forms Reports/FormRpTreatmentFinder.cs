...
///<summary></summary>
	public class FormRpTreatmentFinder:ODForm {
		...
		private void FillGrid() {
			...
			//4=address
			//5=cityStateZip
			col=new ODGridColumn(Lan.g("TableTreatmentFinder","Annual Max"),80);
			...
			table=Patients.GetTreatmentFinderList(checkIncludeNoIns.Checked,checkIncludePatsWithApts.Checked,monthStart,dateSince,aboveAmount,provFilter,billFilter,code1,code2,listClinicNums);
			ODGridRow row;
