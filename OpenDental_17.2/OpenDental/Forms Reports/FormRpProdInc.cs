...
///<summary></summary>
    ...
    private CheckBox checkClinicInfo;
		...
		///<summary>Includes hidden and hidden on reports providers.</summary>
		...
		private void InitializeComponent()
		{
			...
			this.groupShowInsWriteoffs.Location = new System.Drawing.Point(390, 232);
			this.groupShowInsWriteoffs.Name = "groupShowInsWriteoffs";
			this.groupShowInsWriteoffs.Size = new System.Drawing.Size(281, 110);
			...
			this.radioWriteoffProc.Location = new System.Drawing.Point(9, 52);
			...
			this.radioWriteoffPay.Location = new System.Drawing.Point(9, 25);
		...
		private void FormProduction_Load(object sender, System.EventArgs e) {
			//This is used instead of ProviderC.GetListReports() because we need the full list of providers when running All Providers
			//This is so we can show provider specific information in the report.
			_listProviders=ProviderC.GetListLong();
