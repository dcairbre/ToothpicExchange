...
namespace OpenDental{
	...
	public class FormTrackNext : ODForm {
		...
		private void InitializeComponent()
		{
			...
			this.gridMain.Size = new System.Drawing.Size(734, 541);
		...
		private void RefreshAptList() {
			...
			AptList=Appointments.RefreshPlannedTracker(order,provNum,siteNum,clinicNum,codeStart,codeEnd,dateRangePicker.GetDateTimeFrom(),dateRangePicker.GetDateTimeTo());
		}

		private void grid_MouseUp(object sender,MouseEventArgs e) {
			if(e.Button==MouseButtons.Right && gridMain.SelectedIndices.Length>0) {
				Patient pat=Patients.GetLim(AptList[gridMain.SelectedIndices[gridMain.SelectedIndices.Length-1]].PatNum);
