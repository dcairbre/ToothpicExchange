	...
	public partial class FormPatientAddAll:ODForm {
		...
		private void FillComboBillTypes(ComboBox comboBox) {
			...
			for(int i=0;i<DefC.Short[(int)DefCat.BillingTypes].Length;i++){
				comboBox.Items.Add(DefC.Short[(int)DefCat.BillingTypes][i].ItemName);
			...
			for(int i=0;i<arrayPatsInFam.Length;i++) {
				...
				switch(i) {
					case 0://guarantor
						...
						pat.BillingType=DefC.Short[(int)DefCat.BillingTypes][comboBillType1.SelectedIndex].DefNum;
						break;
					case 1://patient 2
						...
						pat.BillingType=DefC.Short[(int)DefCat.BillingTypes][comboBillType2.SelectedIndex].DefNum;
						break;
					case 2://patient 3
						...
						pat.BillingType=DefC.Short[(int)DefCat.BillingTypes][comboBillType3.SelectedIndex].DefNum;
						break;
					case 3://patient 4
						...
						pat.BillingType=DefC.Short[(int)DefCat.BillingTypes][comboBillType4.SelectedIndex].DefNum;
						break;
					case 4://patient 5
						...
						pat.BillingType=DefC.Short[(int)DefCat.BillingTypes][comboBillType5.SelectedIndex].DefNum;
						break;
				}
