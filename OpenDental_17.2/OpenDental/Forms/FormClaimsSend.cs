...
///<summary></summary>
	public class FormClaimsSend:ODForm {
		...
		private void InitializeComponent(){
			...
			this.butDropTo.ImageList = this.imageListCalendars;
			this.butDropTo.Location = new System.Drawing.Point(398, 7);
			...
			this.butDropFrom.ImageList = this.imageListCalendars;
			this.butDropFrom.Location = new System.Drawing.Point(158, 7);
		...
		private void ValidateClaims(List<ClaimSendQueueItem> listClaimSendQueueItems) {
			...
			for(int i=0;i<listClaimsToValidate.Count;i++) {
				Eclaims.GetMissingData(clearinghouseClin,listClaimsToValidate[i]);
