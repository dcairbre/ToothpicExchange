...
namespace OpenDental {
	public partial class FormEServicesSetup {
		...
		private void SaveTabWebSchedRecall() {
			...
			Prefs.UpdateInt(PrefName.WebSchedAutomaticSendTextSetting,(int)sendTypeText);
			Prefs.UpdateInt(PrefName.WebSchedTextsPerBatch,PIn.Int(textWebSchedPerBatch.Text));
		}
		...
		private void FillTabWebSchedRecall() {
			...
			_listWebSchedClinics=Clinics.ListLong;
			...
			_listWebSchedProviders=ProviderC.GetListShort();
