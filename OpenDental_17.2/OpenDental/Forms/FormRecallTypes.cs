...
namespace OpenDental{
	...
	public class FormRecallTypes:ODForm {
		...
		private void butSynch_Click(object sender,EventArgs e) {
			...
			_actionCloseRecallSyncProgress=ODProgress.ShowProgressStatus("RecallSyncEvent"
				,typeof(RecallSyncEvent)
				,tag: new ProgressBarHelper(Lan.g(this,"Running Prep Queries")+"...",null,0,100,ProgBarStyle.Marquee,"Header"));
