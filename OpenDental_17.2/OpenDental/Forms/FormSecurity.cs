...
namespace OpenDental{
	...
	public class FormSecurity:ODForm {
		...
		private CheckBox checkPasswordsStrongIncludeSpecial;
		private CheckBox checkPasswordForceWeakToStrong;
		private CheckBox checkPasswordsMustBeStrong;
		private CheckBox checkTimecardSecurityEnabled;
		private CheckBox checkDomainLoginEnabled;
		private TextBox textDomainLoginPath;
		private Label labelDomainPath;
		...
		private void InitializeComponent()
		{
			...
			this.checkShowHidden.Location = new System.Drawing.Point(340, 59);
			this.checkShowHidden.Name = "checkShowHidden";
			this.checkShowHidden.Size = new System.Drawing.Size(165, 16);
			...
			this.checkShowHidden.MouseClick += new System.Windows.Forms.MouseEventHandler(this.checkShowHidden_MouseClick);
			// 
			// labelFilterType
			// 
			...
			this.checkDisableBackupReminder.Location = new System.Drawing.Point(8, 616);
			...
			this.labelGlobalDateLockDisabled.Location = new System.Drawing.Point(375, 649);
			...
			this.checkUserNameManualEntry.Location = new System.Drawing.Point(238, 634);
			this.checkUserNameManualEntry.Name = "checkUserNameManualEntry";
			this.checkUserNameManualEntry.Size = new System.Drawing.Size(264, 16);
			...
			this.textLogOffAfterMinutes.Location = new System.Drawing.Point(339, 510);
			...
			this.label4.Location = new System.Drawing.Point(372, 510);
			...
			this.label3.Location = new System.Drawing.Point(249, 510);
			...
			this.checkLogOffWindows.Location = new System.Drawing.Point(8, 634);
			...
			this.textDaysLock.Location = new System.Drawing.Point(219, 674);
			...
			this.label2.Location = new System.Drawing.Point(95, 674);
			...
			this.butChange.Location = new System.Drawing.Point(304, 661);
			...
			this.textDateLock.Location = new System.Drawing.Point(219, 653);
			...
			this.label1.Location = new System.Drawing.Point(95, 653);
			...
			this.checkCannotEditOwn.Location = new System.Drawing.Point(8, 598);
			...
			this.gridMain.Size = new System.Drawing.Size(511, 412);
			...
			this.butSetAll.Location = new System.Drawing.Point(525, 669);
			...
			this.butAddUser.Location = new System.Drawing.Point(125, 507);
			...
			this.butAddGroup.Location = new System.Drawing.Point(15, 507);
			...
			this.butClose.Location = new System.Drawing.Point(852, 669);
			...
			// 
			this.checkPasswordsStrongIncludeSpecial.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			...
			this.checkPasswordsStrongIncludeSpecial.Location = new System.Drawing.Point(238, 598);
			this.checkPasswordsStrongIncludeSpecial.Name = "checkPasswordsStrongIncludeSpecial";
			this.checkPasswordsStrongIncludeSpecial.Size = new System.Drawing.Size(264, 16);
			this.checkPasswordsStrongIncludeSpecial.TabIndex = 248;
			...
			// 
			this.checkPasswordForceWeakToStrong.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			...
			this.checkPasswordForceWeakToStrong.Location = new System.Drawing.Point(238, 616);
			this.checkPasswordForceWeakToStrong.Name = "checkPasswordForceWeakToStrong";
			this.checkPasswordForceWeakToStrong.Size = new System.Drawing.Size(264, 16);
			this.checkPasswordForceWeakToStrong.TabIndex = 249;
			...
			this.checkPasswordsMustBeStrong.Location = new System.Drawing.Point(238, 580);
			this.checkPasswordsMustBeStrong.Name = "checkPasswordsMustBeStrong";
			this.checkPasswordsMustBeStrong.Size = new System.Drawing.Size(264, 16);
			...
			this.checkTimecardSecurityEnabled.Location = new System.Drawing.Point(8, 580);
			...
			// 
			this.checkDomainLoginEnabled.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			...
			this.checkDomainLoginEnabled.Location = new System.Drawing.Point(8, 562);
			...
			this.checkDomainLoginEnabled.TabIndex = 250;
			...
			// textDomainLoginPath
			// 
			this.textDomainLoginPath.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.textDomainLoginPath.Location = new System.Drawing.Point(339, 558);
			this.textDomainLoginPath.Name = "textDomainLoginPath";
			this.textDomainLoginPath.Size = new System.Drawing.Size(163, 20);
			this.textDomainLoginPath.TabIndex = 251;
			this.textDomainLoginPath.Leave += new System.EventHandler(this.textDomainLoginPath_Leave);
			// 
			// labelDomainPath
			// 
			this.labelDomainPath.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.labelDomainPath.Location = new System.Drawing.Point(238, 559);
			this.labelDomainPath.Name = "labelDomainPath";
			this.labelDomainPath.Size = new System.Drawing.Size(101, 18);
			this.labelDomainPath.TabIndex = 252;
			...
			this.Controls.Add(this.textDomainLoginPath);
			this.Controls.Add(this.checkDomainLoginEnabled);
		...
		private void FormSecurity_Load(object sender, System.EventArgs e) {
			...
			if(PrefC.HasClinicsEnabled) {
				...
				_listClinics=Clinics.ListShort;
		...
		private void FillGridUsers(){
			...
			ODGridColumn col=new ODGridColumn(Lan.g(tableName,"Username"),90);
			gridMain.Columns.Add(col);
			col=new ODGridColumn(Lan.g(tableName,"Group"),90);
			gridMain.Columns.Add(col);
			col=new ODGridColumn(Lan.g(tableName,"Employee"),90);
			gridMain.Columns.Add(col);
			if(PrefC.IsODHQ) {
				col=new ODGridColumn(Lan.g(tableName,"Job Roles"),60,HorizontalAlignment.Center);
				gridMain.Columns.Add(col);
			}
			col=new ODGridColumn(Lan.g(tableName,"Provider"),90);
			gridMain.Columns.Add(col);
			if(!PrefC.GetBool(PrefName.EasyNoClinics)) {
				col=new ODGridColumn(Lan.g(tableName,"Clinic"),80);
				gridMain.Columns.Add(col);
				col=new ODGridColumn(Lan.g(tableName,"ClinicRestricted"),100,HorizontalAlignment.Center);
				gridMain.Columns.Add(col);
			}
			if(PrefC.GetBool(PrefName.DomainLoginEnabled)) {
				col=new ODGridColumn(Lan.g(tableName,"Domain Username"),120);
				gridMain.Columns.Add(col);
			}
			col=new ODGridColumn(Lan.g(tableName,"Strong"),80,HorizontalAlignment.Center);
			gridMain.Columns.Add(col);
			if(!PrefC.GetBool(PrefName.EasyHideDentalSchools)) {
				col=new ODGridColumn(Lan.g(tableName,"Class"),100);
				gridMain.Columns.Add(col);
			}
			if(checkShowHidden.Checked) {
				col=new ODGridColumn(Lan.g(tableName,"Hidden"),50,HorizontalAlignment.Center);
				gridMain.Columns.Add(col);
			}
			gridMain.Rows.Clear();
			ODGridRow row;
			...
			for(int i=0;i<_listUserodCur.Count;i++) {
				...
				if(PrefC.GetBool(PrefName.DomainLoginEnabled)) {
					row.Cells.Add(_listUserodCur[i].DomainUser);
				}
				...
				if(checkShowHidden.Checked) {
					row.Cells.Add(_listUserodCur[i].IsHidden?"X":"");
				}
		...
		private void FillNodes(TreeNode node,long userGroupNum) {
			...
			List<GroupPermission> listGroupPerms=GroupPermissionC.List.ToList();
			bool hasReportPerms=false;
			for(int i=0;i<listGroupPerms.Count;i++){
				if(listGroupPerms[i].UserGroupNum==userGroupNum
					&& listGroupPerms[i].PermType==(Permissions)node.Tag)
				{
					if(listGroupPerms[i].PermType==Permissions.Reports) {
						if(listGroupPerms[i].FKey!=0 || hasReportPerms) {
							continue;
						}
						//Special case for Reports permission.  If they have the "base" permission we want to see if they have all, none, or part of the reports available.
						int state=DisplayReports.GetReportState(listGroupPerms.FindAll(x => x.PermType==Permissions.Reports && x.FKey!=0));
						if(state==1) {
		...
		private void treePermissions_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e) {
			...
			if(clickedPermNode.ImageIndex==1){//unchecked, so need to add a permission
				...
				else if(perm.PermType==Permissions.Reports) {//Reports permission is being checked.  Show the ReportSetup window.
					FormReportSetup FormRS=new FormReportSetup(SelectedGroupNum,true);
					if(FormRS.ShowDialog()==DialogResult.Cancel) {
						treePermissions.EndUpdate();
						return;
					}
				...
				if((Permissions)clickedPermNode.Tag==Permissions.ProcComplEditLimited
					&& GroupPermissions.HasPermission(SelectedGroupNum,Permissions.ProcComplEdit,0))
				{
					try {
			...
			else if(clickedPermNode.ImageIndex==3) {//Partially checked (currently only applies to Reports permission)
				try {
					GroupPermissions.RemovePermission(SelectedGroupNum,(Permissions)clickedPermNode.Tag);
				}
				catch(Exception ex) {
			...
			if((Permissions)clickedPermNode.Tag==Permissions.AccountProcsQuickAdd) {
		...
		private void textDomainLoginPath_Leave(object sender, EventArgs e) {
			if(PrefC.GetBool(PrefName.DomainLoginEnabled)) {
				if (string.IsNullOrWhiteSpace(textDomainLoginPath.Text)) {
					MsgBox.Show(this,"Warning. Domain Login is enabled, but no path has been entered. If you do not provide a domain path, you will not be able to assign domain logins to users.");
				}
				else {
					try {
						DirectoryEntry.Exists(textDomainLoginPath.Text); //DirectoryEntry.Exists() does not validate the format of the provided string,so it will exception if the provided string is invalid.
					}	
					catch(Exception ex) {
		...
		private void checkShowHidden_MouseClick(object sender,MouseEventArgs e) {
			FillGridUsers();
		}
