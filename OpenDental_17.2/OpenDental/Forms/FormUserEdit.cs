...
namespace OpenDental{
	...
	public class FormUserEdit : ODForm {
		...
		///<summary>The alerts that are available to be selected. Some alert types will not be displayed if this is not OD HQ.</summary>
		private List<AlertType> _listAlertTypes;
		...
		private void InitializeComponent()
		{
			...
			this.butPickDomainUser.Location = new System.Drawing.Point(410, 25);
			...
			// textDomainUser
			// 
			this.textDomainUser.Location = new System.Drawing.Point(218, 26);
			this.textDomainUser.Name = "textDomainUser";
			this.textDomainUser.ReadOnly = true;
			this.textDomainUser.Size = new System.Drawing.Size(188, 20);
			this.textDomainUser.TabIndex = 168;
			// 
			// labelDomainUser
			// 
			this.labelDomainUser.Location = new System.Drawing.Point(218, 6);
			this.labelDomainUser.Name = "labelDomainUser";
			this.labelDomainUser.Size = new System.Drawing.Size(198, 20);
		...
		private void FormUserEdit_Load(object sender, System.EventArgs e) {
			...
			_listAlertTypes=new List<AlertType>();
			foreach(AlertType alertCur in Enum.GetValues(typeof(AlertType))){
				if(alertCur.GetAttributeOrDefault<AlertAttribute>().IsODHQ && !PrefC.IsODHQ) {
					continue;
				}
				int index=listAlertSubMulti.Items.Add(Lan.g(this,alertCur.GetDescription()));
				listAlertSubMulti.SetSelected(index,listAlertTypes.Contains(alertCur));
				_listAlertTypes.Add(alertCur);
			}
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			foreach(int index in listAlertSubMulti.SelectedIndices) {
				listUserAlertTypes.Add(_listAlertTypes[index]);
			}
