...
namespace OpenDental {
	...
	public class FormClinicEdit : ODForm {
		...
		private void InitializeComponent()
		{
			...
			this.checkHidden.Location = new System.Drawing.Point(80, 592);
			...
			// textMedLabAcctNum
			// 
			this.textMedLabAcctNum.Location = new System.Drawing.Point(229, 570);
			...
			// labelMedLabAcctNum
			// 
			this.labelMedLabAcctNum.Location = new System.Drawing.Point(30, 571);
			...
			// textClinicAbbr
			// 
			this.textClinicAbbr.Location = new System.Drawing.Point(229, 71);
			...
			this.checkExcludeFromInsVerifyList.Location = new System.Drawing.Point(11, 178);
			...
			this.tabControl1.Location = new System.Drawing.Point(120, 215);
    ...
    "ddress.";
			...
			this.comboRegion.Location = new System.Drawing.Point(229, 155);
			...
			this.textClinicNum.Location = new System.Drawing.Point(229, 29);
			...
			this.butNone.Location = new System.Drawing.Point(476, 504);
			...
			this.butPickDefaultProv.Location = new System.Drawing.Point(447, 504);
			...
			this.comboDefaultProvider.Location = new System.Drawing.Point(229, 504);
			...
			// label12
			// 
			this.label12.Location = new System.Drawing.Point(30, 506);
			...
			// textFax
			// 
			this.textFax.Location = new System.Drawing.Point(229, 134);
			...
			this.groupBox4.Location = new System.Drawing.Point(216, 401);
			...
			// label10
			// 
			this.label10.Location = new System.Drawing.Point(59, 361);
			...
			this.comboPlaceService.Location = new System.Drawing.Point(229, 526);
			...
			// label7
			// 
			this.label7.Location = new System.Drawing.Point(30, 528);
			...
			this.textEmail.Location = new System.Drawing.Point(229, 358);
			...
			// textBankNumber
			// 
			this.textBankNumber.Location = new System.Drawing.Point(229, 379);
			...
			// textPhone
			// 
			this.textPhone.Location = new System.Drawing.Point(229, 113);
			...
			// textDescription
			// 
			this.textDescription.Location = new System.Drawing.Point(229, 92);
			...
			this.butEmail.Location = new System.Drawing.Point(497, 357);
			...
			this.butOK.Location = new System.Drawing.Point(518, 615);
			...
			this.butCancel.Location = new System.Drawing.Point(599, 615);
			...
			// textExternalID
			// 
			this.textExternalID.Location = new System.Drawing.Point(229, 50);
			...
			// labelExternalID
			// 
			this.labelExternalID.Location = new System.Drawing.Point(19, 50);
			...
			this.comboSpecialty.Location = new System.Drawing.Point(229, 548);
			this.comboSpecialty.MaxDropDownItems = 30;
			this.comboSpecialty.Name = "comboSpecialty";
			this.comboSpecialty.Size = new System.Drawing.Size(216, 21);
			this.comboSpecialty.TabIndex = 50;
			// 
			// label24
			// 
			this.label24.Location = new System.Drawing.Point(30, 550);
			this.label24.Name = "label24";
			this.label24.Size = new System.Drawing.Size(198, 17);
			this.label24.TabIndex = 29;
			this.label24.Text = "Specialty";
			...
			this.butEmailNone.Location = new System.Drawing.Point(526, 357);
		...
		private void FormClinicEdit_Load(object sender, System.EventArgs e) {
			...
			Def defUnspecified=new Def() { DefNum=0,ItemName=Lan.g(this,"Unspecified") };
			List<Def> listSpecialtyDefs=new List<Def>() { defUnspecified };
			listSpecialtyDefs.AddRange(DefC.GetList(DefCat.ClinicSpecialty).ToList());
			foreach(Def def in listSpecialtyDefs) {
				comboSpecialty.Items.Add(new ODBoxItem<Def>(def.ItemName,def));
			}
			comboSpecialty.IndexSelectOrSetText(listSpecialtyDefs.FindIndex(x => x.DefNum==ClinicCur.Specialty)
				,() => { return (ClinicCur.Specialty > 0) ? DefC.GetName(DefCat.ClinicSpecialty,ClinicCur.Specialty)+" "+Lan.g(this,"(hidden)") : ""; });
		}
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			if(_isMedLabHL7DefEnabled //MedLab HL7 def is enabled, so textMedLabAcctNum is visible
				...
				&& Clinics.ListLong.Where(x => x.ClinicNum!=ClinicCur.ClinicNum)
			...
			if(checkHidden.Checked) {
				...
				if(listUsersRestricted.Count > 0) {
					MsgBox.Show(this,Lan.g(this,"You may not hide this clinic as the following users are restricted to only this clinic") + ": "
			...
			if(textExternalID.Text != "") {
				try {
					...
					MsgBox.Show(this,Lan.g(this,"Please fix data entry errors first.")+"\r\n"+Lan.g(this,"The External ID must be a number. No letters or symbols allowed."));
					return;
				}
			}
			...
			if(comboSpecialty.SelectedIndex > -1) {
				ClinicCur.Specialty=((ODBoxItem<Def>)comboSpecialty.SelectedItem).Tag.DefNum;
			}
