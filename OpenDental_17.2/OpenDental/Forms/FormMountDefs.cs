...
namespace OpenDental{
    ...
    "r move any of these items without affecting patient records";
		...
		private void FillList(){
			...
			for(int i=0;i<MountDefs.ListShallow.Count;i++){
				listMain.Items.Add(MountDefs.ListShallow[i].Description);
			}
		}
		...
		private void listMain_DoubleClick(object sender, System.EventArgs e) {
			...
			FormMountDefEdit FormM=new FormMountDefEdit(MountDefs.ListShallow[listMain.SelectedIndex]);
			FormM.ShowDialog();
			FillList();
			changed=true;
		}
