...
namespace OpenDental {
	public partial class FormUnschedListSetup:ODForm {
		...
		private void FormUnschedListSetup_Load(object sender,EventArgs e) {
			...
			textDaysPast.Text=PrefC.GetLong(PrefName.UnschedDaysPast,dictPref).ToString();
			textDaysFuture.Text=PrefC.GetLong(PrefName.UnschedDaysFuture,dictPref).ToString();
		}
