...
///<summary></summary>
	public class FormProviderSetup:ODForm {
		...
		private void FormProviderSetup_Load(object sender, System.EventArgs e) {
			...
			_listProvs=ProviderC.GetListLong();
		...
		private void butMovePri_Click(object sender,EventArgs e) {
			...
			Action actionCloseProgress=ODProgress.ShowProgressStatus("ProviderReassign",Lan.g(this,"Gathering patient data")+"...");
			...
			actionCloseProgress=ODProgress.ShowProgressStatus("ProviderReassign",Lan.g(this,"Moving patients")+"...");
			Cursor=Cursors.WaitCursor;
			int patsMoved=0;
		...
		private void butMoveSec_Click(object sender,EventArgs e) {
			...
			Action actionCloseProgress=ODProgress.ShowProgressStatus("ProviderReassign",Lan.g(this,"Reassigning patients")+"...");
			Cursor=Cursors.WaitCursor;
		...
		private void butReassign_Click(object sender,EventArgs e) {
			...
			Action actionCloseProgress=ODProgress.ShowProgressStatus("ProviderReassign",Lan.g(this,"Gathering patient and provider details")+"...");
			Cursor=Cursors.WaitCursor;
			...
			//display the progress bar, updated by events firing in threads
			actionCloseProgress=ODProgress.ShowProgressStatus("ProviderReassign",Lan.g(this,"Reassigning patients")+"...");
			Cursor=Cursors.WaitCursor;
			ODThread.RunParallel(listActions,TimeSpan.FromMinutes(2));//each group of actions gets 2 minutes
			actionCloseProgress?.Invoke();
			Cursor=Cursors.Default;
