...
namespace OpenDentBusiness{
	...
	public class Accounts {
		...
		public static void Update(Account acct,Account acctOld) {
			...
			Dictionary<long,string> dictJournalEntryDescriptions=table.Rows.Cast<DataRow>().ToDictionary(x => PIn.Long(x["JournalEntryNum"].ToString()),
				x => PIn.String(x["Description"].ToString()));
