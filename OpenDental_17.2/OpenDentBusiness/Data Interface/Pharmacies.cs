...
namespace OpenDentBusiness{
	...
	public class Pharmacies{
		...
		#region CachePattern
		private class PharmacyCache : CacheAbs<Pharmacy> {
		...
		///<summary>A list of all Pharmacies. Returns a shallow copy.</summary>
		public static List<Pharmacy> ListShallow {
			get {
				return _pharmacyCache.ListShallow;
			}
		}

		///<summary>A list of all Pharmacies. Returns a deep copy.</summary>
		public static List<Pharmacy> ListDeep {
			get {
				return _pharmacyCache.ListDeep;
			}
		}
		...
		public static string GetDescription(long PharmacyNum) {
			...
			for(int i=0;i<ListShallow.Count;i++){
				if(ListShallow[i].PharmacyNum==PharmacyNum){
					return ListShallow[i].StoreName;
				}
			}
			return "";
		}
