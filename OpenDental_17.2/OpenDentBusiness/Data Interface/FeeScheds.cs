...
namespace OpenDentBusiness{
	...
	public class FeeScheds{
		...
		public static string GetDescription(long feeSchedNum,List<FeeSched> listFeeScheds=null) {
			//No need to check RemotingRole; no call to db.
			string feeSchedDesc="";
			if(feeSchedNum==0) {
				return feeSchedDesc;
		...
		public static bool GetIsHidden(long feeSchedNum) {
			//No need to check RemotingRole; no call to db.
			return FeeSchedC.GetIsHidden(feeSchedNum);
		}
		...
		public static bool IsGlobal(long feeSchedNum) {
			//No need to check RemotingRole; no call to db.
			return FeeSchedC.GetIsGlobal(feeSchedNum);
		}
