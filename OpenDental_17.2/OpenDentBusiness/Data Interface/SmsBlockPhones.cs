...
namespace OpenDentBusiness {
	...
	public class SmsBlockPhones {
		...
		private class SmsBlockPhoneCache : CacheAbs<SmsBlockPhone> {
		...
		///<summary>A list of all SmsBlockPhones. Returns a deep copy.</summary>
		public static List<SmsBlockPhone> ListDeep {
			get {
				return _smsBlockPhoneCache.ListDeep;
			}
		}

		///<summary>A list of all non-hidden SmsBlockPhones. Returns a deep copy.</summary>
		public static List<SmsBlockPhone> ListShortDeep {
			get {
				return _smsBlockPhoneCache.ListShortDeep;
			}
		}

		///<summary>A list of all SmsBlockPhones. Returns a shallow copy.</summary>
		public static List<SmsBlockPhone> ListShallow {
			get {
				return _smsBlockPhoneCache.ListShallow;
			}
		}

		///<summary>A list of all non-hidden SmsBlockPhones. Returns a shallow copy.</summary>
		public static List<SmsBlockPhone> ListShortShallow {
			get {
				return _smsBlockPhoneCache.ListShallowShort;
			}
		}
