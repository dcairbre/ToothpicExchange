...
namespace OpenDentBusiness {
	...
	public enum PrefName {
		...
		///<summary>Comma delimited list of FKey to definition.DefNum. Every appointment with a confirmed status that is in this list will be excluded from EReminders.</summary>
		...
		///<summary>Date,  Defaults to the day you update to 17.1.  Used to filter out Outstanding Claims from FormClaimPayBatch list</summary>
    ...
    LocalTimeOverridesServerTime,
		...
		///<summary>Deprecated. Also spelt wrong.</summary>
    ...
    ///<summary>Boolean, off by default.</summary>
		...
		RequiredFieldColor,
		RxSendNewToQueue,
		///<summary>FKey to definition.DefNum.  Represents default adjustment types for sales tax adjustments.</summary>
		...
		///<summary>Deprecated in v17.1 via forcing the TreatPlanUseSheets preference on.  Treatment plan printing code was not altered.
		///The old code will be completely removed in v17.2 (or higher).</summary>
		TreatPlanUseSheets,
