...
namespace OpenDentBusiness {
	...
	public class DbHelper {
		...
		public static string DtimeToDate(string colName,ConditionOperator compareType,DateTime dateTime) {
			//Oracle compatible.
			switch(compareType) {
		...
		public static string BetweenDates(string colName,DateTime dateTimeFrom,DateTime dateTimeTo) {
			return DtimeToDate(colName,ConditionOperator.GreaterThanOrEqual,dateTimeFrom)+" AND "
				+DtimeToDate(colName,ConditionOperator.LessThanOrEqual,dateTimeTo);
		}
