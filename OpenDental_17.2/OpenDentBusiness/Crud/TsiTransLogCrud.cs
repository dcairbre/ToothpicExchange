...
namespace OpenDentBusiness.Crud{
	public class TsiTransLogCrud {
		...
		public static long Insert(TsiTransLog tsiTransLog,bool useExistingPK){
			...
			command+="PatNum,UserNum,TransType,TransDateTime,DemandType,ServiceCode,TransAmt,AccountBalance,FKeyType,FKey,RawMsgText) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
			...
			if(useExistingPK || PrefC.RandomKeys) {
				...
				tsiTransLog.TsiTransLogNum=Db.NonQ(command,true);
			}
