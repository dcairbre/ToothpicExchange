	...
	public class RepeatChargeCrud {
		...
		public static long Insert(RepeatCharge repeatCharge,bool useExistingPK){
			...
			command+=
				...
				+    POut.Bool  (repeatCharge.IsEnabled)+","
				+    POut.Bool  (repeatCharge.UsePrepay)+","
				+"'"+POut.String(repeatCharge.Npi)+"',"
				+"'"+POut.String(repeatCharge.ErxAccountId)+"',"
				+"'"+POut.String(repeatCharge.ProviderName)+"')";
			if(useExistingPK || PrefC.RandomKeys) {
				Db.NonQ(command);
			}
			else {
		...
		public static void Update(RepeatCharge repeatCharge){
			string command="UPDATE repeatcharge SET "
				...
				+"Npi            = '"+POut.String(repeatCharge.Npi)+"', "
				+"ErxAccountId   = '"+POut.String(repeatCharge.ErxAccountId)+"', "
				+"ProviderName   = '"+POut.String(repeatCharge.ProviderName)+"' "
		...
		public static bool Update(RepeatCharge repeatCharge,RepeatCharge oldRepeatCharge){
			...
			if(repeatCharge.Npi != oldRepeatCharge.Npi) {
				if(command!=""){ command+=",";}
				command+="Npi = '"+POut.String(repeatCharge.Npi)+"'";
			}
			if(repeatCharge.ErxAccountId != oldRepeatCharge.ErxAccountId) {
				if(command!=""){ command+=",";}
				command+="ErxAccountId = '"+POut.String(repeatCharge.ErxAccountId)+"'";
			}
			if(repeatCharge.ProviderName != oldRepeatCharge.ProviderName) {
				if(command!=""){ command+=",";}
				command+="ProviderName = '"+POut.String(repeatCharge.ProviderName)+"'";
			}
			if(command==""){
				return false;
			}
