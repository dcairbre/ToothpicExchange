...
namespace OpenDentBusiness.Crud{
	public class JobCrud {
		...
		public static long Insert(Job job,bool useExistingPK){
			...
			command+="UserNumConcept,UserNumExpert,UserNumEngineer,UserNumApproverConcept,UserNumApproverJob,UserNumApproverChange,UserNumDocumenter,UserNumCustContact,UserNumCheckout,UserNumInfo,ParentNum,DateTimeCustContact,Priority,Category,JobVersion,HoursEstimate,HoursActual,DateTimeEntry,Description,Documentation,Title,PhaseCur,IsApprovalNeeded,AckDateTime,UserNumQuoter,UserNumApproverQuote,UserNumCustQuote) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
