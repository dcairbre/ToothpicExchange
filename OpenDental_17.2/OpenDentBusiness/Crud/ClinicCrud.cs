	...
	public class ClinicCrud {
		...
		public static List<Clinic> TableToList(DataTable table){
			...
			foreach(DataRow row in table.Rows) {
				...
				clinic.Specialty           = PIn.Long  (row["Specialty"].ToString());
				retVal.Add(clinic);
			}
			return retVal;
		}
		...
		public static void Update(Clinic clinic){
			string command="UPDATE clinic SET "
				...
				+"Specialty           =  "+POut.Long  (clinic.Specialty)+" "
		...
		public static bool Update(Clinic clinic,Clinic oldClinic){
			...
			if(clinic.Specialty != oldClinic.Specialty) {
				if(command!=""){ command+=",";}
				command+="Specialty = "+POut.Long(clinic.Specialty)+"";
			}
			if(command==""){
				return false;
			}
